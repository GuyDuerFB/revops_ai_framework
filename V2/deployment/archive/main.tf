terraform {
  required_providers {
    aws = {
      ...
      version = "~> 5.0" # Use a slightly older, more stable version
    }
  }
}
...
module "agents" {
  ...
  agents = {
    data_agent = {
      ...
      instruction      = file("${path.module}/../../agents/data_agent/instructions.md")
    ...
    execution_agent = {
      ...
      foundation_model = "anthropic.claude-3-7-sonnet-20250219-v1:0"
      instruction      = file("${path.module}/../../agents/execution_agent/instructions.md")
      knowledge_bases  = []
    ...
    # Additional agents (deal_quality_agent and consumption_agent) will be added in future deployment phases
  }
...
# Flows module commented out since flow definition files don't exist yet
# Will be enabled in later deployment phases
/*
module "flows" {
  source = "./modules/flow"
...
// The following line was part of the flow module and has been commented out
